...
function Answer() {
  ...
  const AnswerComponent = () => {
    ...
    <Row>
      <Col span={8}>
        <Checkbox onClick={onClickAnswerButton(0)} value="0"><li>아니요</li></Checkbox>
      </Col>
      <Col span={8}>
        <Checkbox onClick={onClickAnswerButton(1)} value="1"><li>아닐겁니다</li></Checkbox>
      </Col>
      <Col span={8}>
        <Checkbox onClick={onClickAnswerButton(2)} value="2"><li>잘모르겠습니다</li></Checkbox>
      </Col>
      <Col span={8}>
        <Checkbox onClick={onClickAnswerButton(3)} value="3"><li>그럴겁니다</li></Checkbox>
      </Col>
      <Col span={8}>
        <Checkbox onClick={onClickAnswerButton(4)} value="4"><li>네</li></Checkbox>
      </Col>
    </Row>
    </Checkbox.Group>
  </>
